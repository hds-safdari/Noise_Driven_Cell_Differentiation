for cl =1:10 % number of individual RUNs
    ...
    while t < tend
        ...
        model.func('int1').set('filename', ['FILE PATH' name]);
        ...
        model.func('int2').set('filename', ['FILE PATH' name]);
        ...
        if (t== tend)
            ...
            name = ['OUTPUT PATH/var_' num2str(var,'%d') '_org_' num2str(cl,'%d') '.eps'];
            print( name ,'-depsc')
        end
    end
...
name = ['OUTPUT PATH/clust_coeff_T_0' num2str(var,'%d') '.txt'];
